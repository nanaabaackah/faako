  ...
  return (
    <section className="page pricing page-stack">
      ...
      <section className="pricing-hero split">
        <div className="pricing-hero-copy reveal" style={{ "--delay": "0ms" }}>
      ...
      <section className="section pricing-intro section-seam-top section-surface-brown section-seam-bottom">
      ...
      {/* 3. What's Included */}
      <section className="section pricing-includes">
          <div className="section section-header reveal" style={{ "--delay": "0ms" }}>
            <div className="pricing-details reveal" style={{ "--delay": "0ms" }}>
      ...
      {/* 4. Plan Comparison */}
      <section className="section pricing-compare section-seam-top section-surface-brown">
      ...
      {/* 5. Add-on Modules */}
      <section className="section pricing-addons section-surface-brown section-seam-bottom">
      ...
      <section className="section consulting-advisory">
      ...
      <Testimonials
        className="section testimonials section-surface-brown section-seam-top"
        eyebrow="Client Love"
      ...
      {/* 8. FAQs */}
      <FaqSection
        className="faq-section section-seam-bottom section-surface-brown"
        eyebrow="FAQs"
